...
greece_trip = Trip.create(title: "Summer Greece", blurb: "saw a lot. did a lot.", start_date: '2017-04-26', end_date: '2017-04-30', intensity: 5, user_id: christina.id)
sf_trip = Trip.create(title: "Tech in SF", blurb: "OMG so much tech in SF", start_date: '2017-06-04', end_date: '2017-06-03', intensity: 3, user_id: christina.id)
israel_trip = Trip.create(title: "Summer in Israel", blurb: "traveled the span of the country in less than a week", start_date: '2016-11-08', end_date: '2016-11-14', intensity: 4, user_id: matt.id)
...
TripDestination.create(trip_id: greece_trip.id, destination_id: acropolis.id, day: 1)
TripDestination.create(trip_id: greece_trip.id, destination_id: hadrian_arch.id, day: 2)
TripDestination.create(trip_id: sf_trip.id, destination_id: coit_tower.id, day: 1)
TripDestination.create(trip_id: sf_trip.id, destination_id: sf_rest.id, day: 1)
TripDestination.create(trip_id: israel_trip.id, destination_id: dead_sea.id, day: 1)
TripDestination.create(trip_id: israel_trip.id, destination_id: golan_heights.id, day: 1)
TripDestination.create(trip_id: greece_trip.id, destination_id: oia.id, day: 1)
